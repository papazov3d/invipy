...
# ListWidget ================================================================================================
#============================================================================================================
class ListWidget(modelview.Observer):
  def __init__(self, data_container):
    self.__data_container = data_container
    # Make sure that the data container has the right type
    if not isinstance(self.__data_container, dc.DataContainer):
  ...
  def __update_selection(self, data):
    ...
    print("__update_selection(): " + str(len(data)) + " model(s)")
